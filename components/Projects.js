...
const Projects = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full md:h-screen  h-screen flex relative overflow-hidden flex-col text-lft md:flex-col max-w-full md:px-10 md:mb-64 mx-auto items-center"
    >
      ...
      <div className="relative w-full mx-auto md:p-5 z-20 text-xs md:text-xl">
        ...
        <div className="w-full flex-shrink-0 flex flex-col space-y-5 items-center justify-center p-10 md:p-20 md:px-64">
            <ProjectItems
              title="ProjectFM"
              backgroundImg={pfmImage}
              projectUrl="/projectFM"
              code="NextJS, JavaScript, HTML, Tailwind CSS and PropelAuth"
            />
          </div>
          <div className="w-full flex-shrink-0 flex flex-col space-y-5 items-center justify-center p-10 md:p-20 md:px-64">
            <ProjectItems
